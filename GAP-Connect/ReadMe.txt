========================================================================
    ANWENDUNG: GAP-Connect-Projektübersicht
========================================================================

Diese GAP-Connect-Anwendung wurde vom Anwendungs-Assistenten 
für Sie erstellt.  

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, 
aus denen Ihre GAP-Connect-Anwendung besteht.
...
StdAfx.h, StdAfx.cpp
    ...
    (PCH-Datei) mit dem Namen "GAP-Connect.pch und eine 
